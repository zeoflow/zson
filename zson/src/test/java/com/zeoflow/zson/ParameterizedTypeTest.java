...
/**
 * Unit tests for {@code ParameterizedType}s created by the {@link $Zson$Types} class.
 *
...
public class ParameterizedTypeTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    super.setUp();
    ourType = $Zson$Types.newParameterizedTypeWithOwner(null, List.class, String.class);
  }
