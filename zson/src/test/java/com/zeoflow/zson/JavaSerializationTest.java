...
/**
 * Check that Zson doesn't return non-serializable data types.
 *
 * @author Jesse Wilson
 */
public final class JavaSerializationTest extends TestCase {
  ...
  public void testMapIsSerializable() throws Exception {
    ...
    Map<String, Integer> map = zson.fromJson("{\"b\":1,\"c\":2,\"a\":3}", type);
  ...
  public void testListIsSerializable() throws Exception {
    ...
    List<String> list = zson.fromJson("[\"a\",\"b\",\"c\"]", type);
  ...
  public void testNumberIsSerializable() throws Exception {
    ...
    List<Number> list = zson.fromJson("[1,3.14,6.673e-11]", type);
