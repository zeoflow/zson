...
/**
 * Unit tests for the {@code GenericArrayType}s created by the {@link $Zson$Types} class.
 *
...
public class GenericArrayTypeTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    super.setUp();
    ourType = $Zson$Types.arrayOf($Zson$Types.newParameterizedTypeWithOwner(null, List.class, String.class));
  }
