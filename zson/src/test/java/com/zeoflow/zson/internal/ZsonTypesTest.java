...
package com.zeoflow.zson.internal;
...
public final class ZsonTypesTest extends TestCase {

  public void testNewParameterizedTypeWithoutOwner() throws Exception {
    // List<A>. List is a top-level class
    Type type = $Zson$Types.newParameterizedTypeWithOwner(null, List.class, A.class);
    assertEquals(A.class, getFirstTypeArgument(type));

    // A<B>. A is a static inner class.
    type = $Zson$Types.newParameterizedTypeWithOwner(null, A.class, B.class);
    ...
    try {
      ...
      $Zson$Types.newParameterizedTypeWithOwner(null, D.class, A.class);
      fail();
    } catch (IllegalArgumentException expected) {}

    // A<D> is allowed.
    type = $Zson$Types.newParameterizedTypeWithOwner(null, A.class, D.class);
  ...
  public void testGetFirstTypeArgument() throws Exception {
    ...
    Type type = $Zson$Types.newParameterizedTypeWithOwner(null, A.class, B.class, C.class);
    assertEquals(B.class, getFirstTypeArgument(type));
  }
  ...
  public static Type getFirstTypeArgument(Type type) throws Exception {
    ...
    return $Zson$Types.canonicalize(actualTypeArguments[0]);
  }
}
