...
/**
 * Tests for Zson serialization of a sub-class object while encountering a base-class type
 *
...
public class MoreSpecificTypeSerializationTest extends TestCase {
  ...
  public void testMapOfSubclassFields() {
    ...
    JsonObject json = zson.toJsonTree(target).getAsJsonObject().get("map").getAsJsonObject();
  ...
  /**
   * For parameterized type, Zson ignores the more-specific type and sticks to the declared type
   */
  ...
  /**
   * For parameterized type in a List, Zson ignores the more-specific type and sticks to
   * the declared type
   */
  ...
  /**
   * For parameterized type in a map, Zson ignores the more-specific type and sticks to the
   * declared type
   */
