...
public final class StreamingTypeAdaptersTest extends TestCase {
  private Zson miniZson = new ZsonBuilder().create();
  private TypeAdapter<Truck> truckAdapter = miniZson.getAdapter(Truck.class);
  private TypeAdapter<Map<String, Double>> mapAdapter
      = miniZson.getAdapter(new TypeToken<Map<String, Double>>() {});
  ...
  private void usePersonNameAdapter() {
    ...
    miniZson = new ZsonBuilder().registerTypeAdapter(Person.class, personNameAdapter).create();
    truckAdapter = miniZson.getAdapter(Truck.class);
  }
  ...
  public void testSerialize1dArray() {
    TypeAdapter<double[]> arrayAdapter = miniZson.getAdapter(new TypeToken<double[]>() {});
  ...
  public void testNullSafe() {
    ...
    try {
      zson.toJson(truck, Truck.class);
      fail();
    } catch (NullPointerException expected) {}
    String json = "{horsePower:1.0,passengers:[null,'jesse,30']}";
    try {
      zson.fromJson(json, Truck.class);
      fail();
    } catch (JsonSyntaxException expected) {}
    zson = new ZsonBuilder().registerTypeAdapter(Person.class, typeAdapter.nullSafe()).create();
    assertEquals("{\"horsePower\":1.0,\"passengers\":[null,\"jesse,30\"]}",
        zson.toJson(truck, Truck.class));
    truck = zson.fromJson(json, Truck.class);
  ...
  public void testSerializeRecursive() {
    TypeAdapter<Node> nodeAdapter = miniZson.getAdapter(Node.class);
