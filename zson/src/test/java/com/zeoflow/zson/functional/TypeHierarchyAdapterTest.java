...
public final class TypeHierarchyAdapterTest extends TestCase {
  ...
  public void testTypeHierarchy() {
    ...
    String json = zson.toJson(company, Company.class);
    assertEquals("{\n" +
        "  \"ceo\": {\n" +
        "    \"userid\": \"eric\",\n" +
        "    \"startDate\": 2001,\n" +
    ...
    Company copied = zson.fromJson(json, Company.class);
    assertEquals(json, zson.toJson(copied, Company.class));
  ...
  public void testRegisterSuperTypeFirst() {
    ...
    String json = zson.toJson(manager, Manager.class);
    assertEquals("\"inder\"", json);
    Manager copied = zson.fromJson(json, Manager.class);
    assertEquals(manager.userid, copied.userid);
  }

  /** This behaviour changed in Zson 2.1; it used to throw. */
