...
public class CircularReferenceTest extends TestCase {
  ...
  public void testSelfReferenceCustomHandlerSerialization() throws Exception {
    ...
    obj.child = obj;
    Zson zson = new ZsonBuilder().registerTypeAdapter(ClassWithSelfReference.class, new JsonSerializer<ClassWithSelfReference>() {
