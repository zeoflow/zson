...
import com.zeoflow.zson.common.MoreAsserts;
...
public class EnumTest extends TestCase {
  ...
  public void testTopLevelEnumSerialization() throws Exception {
    String result = zson.toJson(MyEnum.VALUE1);
    assertEquals('"' + MyEnum.VALUE1.toString() + '"', result);
  }

  public void testTopLevelEnumDeserialization() throws Exception {
    MyEnum result = zson.fromJson('"' + MyEnum.VALUE1.toString() + '"', MyEnum.class);
  ...
  public void testCollectionOfEnumsSerialization() {
    ...
    String actualJson = zson.toJson(target);
    assertEquals(expectedJson, actualJson);
    actualJson = zson.toJson(target, type);
    assertEquals(expectedJson, actualJson);
  }
  ...
  public void testCollectionOfEnumsDeserialization() {
    ...
    Collection<MyEnum> target = zson.fromJson(json, type);
  ...
  public void testClassWithEnumFieldDeserialization() throws Exception {
    ...
    ClassWithEnumFields target = zson.fromJson(json, ClassWithEnumFields.class);
  ...
  public void testEnumSubclass() {
    ...
    assertEquals("\"ROCK\"", zson.toJson(Roshambo.ROCK));
    assertEquals("[\"ROCK\",\"PAPER\",\"SCISSORS\"]", zson.toJson(EnumSet.allOf(Roshambo.class)));
    assertEquals(Roshambo.ROCK, zson.fromJson("\"ROCK\"", Roshambo.class));
    assertEquals(EnumSet.allOf(Roshambo.class),
        zson.fromJson("[\"ROCK\",\"PAPER\",\"SCISSORS\"]", new TypeToken<Set<Roshambo>>() {}.getType()));
  }
  ...
  public void testEnumSubclassWithRegisteredTypeAdapter() {
    zson = new ZsonBuilder()
        ...
        .create();
    assertFalse(Roshambo.class == Roshambo.ROCK.getClass());
    assertEquals("\"123ROCK\"", zson.toJson(Roshambo.ROCK));
    assertEquals("[\"123ROCK\",\"123PAPER\",\"123SCISSORS\"]", zson.toJson(EnumSet.allOf(Roshambo.class)));
    assertEquals(Roshambo.ROCK, zson.fromJson("\"123ROCK\"", Roshambo.class));
    assertEquals(EnumSet.allOf(Roshambo.class),
        zson.fromJson("[\"123ROCK\",\"123PAPER\",\"123SCISSORS\"]", new TypeToken<Set<Roshambo>>() {}.getType()));
  }
  ...
  public void testEnumSubclassAsParameterizedType() {
    ...
    Collection<Roshambo> actualJsonList = zson.fromJson(json, collectionType);
  ...
  public void testEnumCaseMapping() {
    assertEquals(Gender.MALE, zson.fromJson("\"boy\"", Gender.class));
    assertEquals("\"boy\"", zson.toJson(Gender.MALE, Gender.class));
  }

  public void testEnumSet() {
    EnumSet<Roshambo> foo = EnumSet.of(Roshambo.ROCK, Roshambo.PAPER);
    String json = zson.toJson(foo);
    Type type = new TypeToken<EnumSet<Roshambo>>() {}.getType();
    EnumSet<Roshambo> bar = zson.fromJson(json, type);
  ...
  public void testEnumClassWithFields() {
	  assertEquals("\"RED\"", zson.toJson(Color.RED));
	  assertEquals("red", zson.fromJson("RED", Color.class).value);
  }
