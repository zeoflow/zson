...
/**
 * Tests for ensuring Zson thread-safety.
 * 
...
public class ConcurrencyTest extends TestCase {
   ...
   * http://groups.google.com/group/google-Zson/browse_thread/thread/563bb51ee2495081
   */
  ...
  public void testSingleThreadDeserialization() { 
    for (int i = 0; i < 10; i++) { 
      zson.fromJson("{'a':'hello','b':'world','i':1}", MyObject.class);
    } 
  } 
