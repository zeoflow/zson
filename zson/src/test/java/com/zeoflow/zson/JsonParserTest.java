...
import com.zeoflow.zson.common.TestTypes.BagOfPrimitives;
...
public class JsonParserTest extends TestCase {
  ...
  public void testReadWriteTwoObjects() throws Exception {
    ...
    BagOfPrimitives actualOne = zson.fromJson(element1, BagOfPrimitives.class);
    assertEquals("one", actualOne.stringValue);
    BagOfPrimitives actualTwo = zson.fromJson(element2, BagOfPrimitives.class);
