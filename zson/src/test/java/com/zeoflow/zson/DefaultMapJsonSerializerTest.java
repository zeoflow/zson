...
public class DefaultMapJsonSerializerTest extends TestCase {
  private Zson zson = new Zson();

  public void testEmptyMapNoTypeSerialization() {
    Map<String, String> emptyMap = new HashMap<String, String>();
    JsonElement element = zson.toJsonTree(emptyMap, emptyMap.getClass());
  ...
  public void testEmptyMapSerialization() {
    ...
    Map<String, String> emptyMap = new HashMap<String, String>();
    JsonElement element = zson.toJsonTree(emptyMap, mapType);
  ...
  public void testNonEmptyMapSerialization() {
    ...
    Zson zson = new Zson();
    JsonElement element = zson.toJsonTree(myMap, mapType);
