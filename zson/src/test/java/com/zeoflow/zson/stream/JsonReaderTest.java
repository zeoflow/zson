...
package com.zeoflow.zson.stream;
...
public final class JsonReaderTest extends TestCase {
  ...
  public void testDeeplyNestedArrays() throws IOException {
    // this is nested 40 levels deep; Zson is tuned for nesting is 30 levels deep or fewer
    JsonReader reader = new JsonReader(reader(
        "[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]"));
    for (int i = 0; i < 40; i++) {
      reader.beginArray();
  ...
  // http://code.google.com/p/google-Zson/issues/detail?id=409
  ...
  /**
   * This test behave slightly differently in Zson 2.2 and earlier. It fails
