...
package com.zeoflow.zson.annotations;
 ...
 *
 * <p>This annotation has no effect unless you build {@link Zson}
 * with a {@link ZsonBuilder} and invoke
 * {@link ZsonBuilder#excludeFieldsWithoutExposeAnnotation()}
 * method.</p>
 *
 ...
 * with {@code Zson Zson = new ZsonBuilder().excludeFieldsWithoutExposeAnnotation().create()}
 * then the {@code toJson()} and {@code fromJson()} methods of Zson will exclude the
 * {@code password} field. This is because the {@code password} field is not marked with the
 * {@code @Expose} annotation. Zson will also exclude {@code lastName} and {@code emailAddress}
 * from serialization since {@code serialize} is set to {@code false}. Similarly, Zson will
 ...
 * {@code password} field as {@code transient}, and Zson would have excluded it even with default
