...
/**
 * An annotation that indicates the Zson {@link TypeAdapter} to use with a class
 * or field.
 *
 ...
 * field's type, and in the {@link ZsonBuilder}. Field
 * annotations take precedence over {@code ZsonBuilder}-registered type
 ...
 * to the enclosing {@code Zson} instance.
 *
 * @since 2.3
 *
