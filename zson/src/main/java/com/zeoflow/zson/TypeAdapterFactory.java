 ...
 * ZsonBuilder} for them to take effect: <pre>   {@code
 *
 ...
 * multiset's type token. A {@code Zson} is passed in to {@code create} for
 ...
 *       TypeAdapter<?> elementAdapter = Zson.getAdapter(TypeToken.get(elementType));
 ...
 * the foundation of how Zson converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
   ...
   * support {@code type}.
   */
  <T> TypeAdapter<T> create(Zson zson, TypeToken<T> type);
}
