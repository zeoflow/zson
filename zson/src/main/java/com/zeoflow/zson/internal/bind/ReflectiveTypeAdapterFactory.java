...
import com.zeoflow.zson.internal.reflect.ReflectionAccessor;
...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
  ...
  @Override public <T> TypeAdapter<T> create(Zson zson, final TypeToken<T> type) {
    ...
    return new Adapter<T>(constructor, getBoundFields(zson, type, raw));
  }

  private ReflectiveTypeAdapterFactory.BoundField createBoundField(
      final Zson context, final Field field, final String name,
  ...
  private Map<String, BoundField> getBoundFields(Zson context, TypeToken<?> type, Class<?> raw) {
    ...
    while (raw != Object.class) {
      ...
      for (Field field : fields) {
        ...
        Type fieldType = $Zson$Types.resolve(type.getType(), raw, field.getGenericType());
      ...
      type = TypeToken.get($Zson$Types.resolve(type.getType(), raw, raw.getGenericSuperclass()));
      raw = type.getRawType();
    }
    return result;
  }
