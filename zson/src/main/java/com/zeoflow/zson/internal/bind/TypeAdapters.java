...
import com.zeoflow.zson.JsonIOException;
...
import com.zeoflow.zson.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
  ...
  public static final TypeAdapter<Boolean> BOOLEAN = new TypeAdapter<Boolean>() {
    ...
    public Boolean read(JsonReader in) throws IOException {
      ...
      if (peek == JsonToken.NULL) {
        ...
        // support strings for compatibility with Zson 1.7
  ...
  public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
    ...
    @Override public <T> TypeAdapter<T> create(Zson zson, TypeToken<T> typeToken) {
      ...
      final TypeAdapter<Date> dateTypeAdapter = zson.getAdapter(Date.class);
  ...
  public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
    ...
    return new TypeAdapterFactory() {
      ...
      @Override public <T2> TypeAdapter<T2> create(Zson zson, TypeToken<T2> typeToken) {
