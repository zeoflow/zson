...
public final class CollectionTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public <T> TypeAdapter<T> create(Zson zson, TypeToken<T> typeToken) {
    ...
    Type elementType = $Zson$Types.getCollectionElementType(type, rawType);
    TypeAdapter<?> elementTypeAdapter = zson.getAdapter(TypeToken.get(elementType));
    ObjectConstructor<T> constructor = constructorConstructor.get(typeToken);

    @SuppressWarnings({"unchecked", "rawtypes"}) // create() doesn't define a type parameter
    TypeAdapter<T> result = new Adapter(zson, elementType, elementTypeAdapter, constructor);
    return result;
  }
  ...
  private static final class Adapter<E> extends TypeAdapter<Collection<E>> {
    ...
    public Adapter(Zson context, Type elementType,
